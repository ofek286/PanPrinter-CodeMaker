...
public class CodeMaker extends javax.swing.JFrame {
    ...
    private final static String[] tables = {table16x16, table19x19};
    
    private static String _fileName;
    
    private static String _COM;
    
    private final static int INDEX_15C = -1, INDEX_16C = 0, INDEX_18C = -1, INDEX_19C = 1;
    ...
    private void initComponents() {
        ...
        table16C = new panprinter.Table16x16();
        table19C = new panprinter.Table19x19();
        gridReseter = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("PanPrinter AdvancedUI");
        ...
        gridPanel.setLayout(new java.awt.CardLayout());
        gridPanel.add(table16C, "16x16");
        gridPanel.add(table19C, "19x19");

        gridReseter.setText("איפוס לוח הציור");
        gridReseter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gridReseterActionPerformed(evt);
            }
        });
        ...
        CardLayout cl = (CardLayout) gridPanel.getLayout();
        cl.show(gridPanel, table16x16);
    ...
    private void tableChangerItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_tableChangerItemStateChanged
        CardLayout cl = (CardLayout) gridPanel.getLayout();
        cl.show(gridPanel, (String) (evt.getItem()));;
        /*
    ...
    private void gridReseterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gridReseterActionPerformed
        HeatLevel[][] grid;
        switch ((String)tableChanger.getSelectedItem())
        {
            case table15x15: grid = new HeatLevel[15][15]; gridReseter(grid); table15C.changeBy(grid); break;
            case table16x16: grid = new HeatLevel[16][16]; gridReseter(grid); table16C.changeBy(grid); break;
            case table18x18: grid = new HeatLevel[18][18]; gridReseter(grid); table18C.changeBy(grid); break;
            case table19x19: grid = new HeatLevel[19][19]; gridReseter(grid); table19C.changeBy(grid); break;
                
        }
    }//GEN-LAST:event_gridReseterActionPerformed

    private void fileOpener(File file) {
        boolean hello = false, check = false, osGrid = false;
        String currLine, fullCode = "";
    ...
    private javax.swing.JButton gridReseter;
    ...
    private panprinter.Table16x16 table16C;
    private panprinter.Table18x18 table18C;
    private panprinter.Table19x19 table19C;
